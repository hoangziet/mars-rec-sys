"""
scripts/rq3_compare.py
=======================
RQ3: Statistical comparison of metadata variants on test set.
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="RQ3: statistical comparison of metadata variants.")
...
def main() -> None:
    ...
    with open(output_dir / "rq3_statistical_comparison.csv", "w", newline="") as f:
