...
.PHONY: preprocess rq1-smoke rq1-full rq1-report rq1-compare test rq2-alpha rq2-alpha-report rq2-variants rq2-report rq2-compare rq2-all rq3-precompute rq3-tune rq3-report rq3-compare rq3-all
...
RQ3_BENCHMARK_ID ?= rq3-metadata-base-ce
...
rq3-report:
	uv run python scripts/rq3_report.py --benchmark-id $(RQ3_BENCHMARK_ID) --output-dir $(RQ3_REPORT_OUTPUT_DIR)
