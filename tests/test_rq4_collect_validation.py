...
def _make_run(variant, seed, alpha, use_structured=False, use_text=False, drop_alpha=False, drop_flags=False):
    tags = {
        "reportable": "true",
    ...
    return {"variant": variant, "seed": seed, "tags": tags}
